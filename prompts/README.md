...
| **project** | `/new-project`, `/init-workspace`, `/setup-claude`, `/init-claude-config`, `/validate-claude-config`, `/init-pm2`, `/init-harness`, `/create-mono-repo`, `/migrate-submodules`, `/submodule-check` |
...
| `/setup-claude` | Manage framework submodules |
| `/init-claude-config` | Initialize .kimi submodule |
| `/validate-claude-config` | Validate .kimi configuration |
...
| `/audit-system` | Comprehensive .kimi system audit |
