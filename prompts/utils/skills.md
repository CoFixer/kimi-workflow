...
Display all available skills, commands, and their magic keywords from the .kimi 3-tier system. Optionally recommend skills based on what the user is working on.
...
- `.kimi/prompts/**/*.md` (project-level commands from all subdirectories)
- `.kimi/skills/**/SKILL.md` (skills from enabled stacks)
