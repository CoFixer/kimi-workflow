...
**Example checks:**
```bash
ls .kimi/prompts/agent/ralph.md
...
References to non-existent resources:
  ...
  - .kimi/prompts/dev/fullstack.md:23 references "api-validator" (NOT IN REGISTRY)
...
|---------|---------|------------|
| File path reference | `Command File: .kimi/prompts/dev/foo.md` | Check file exists |
