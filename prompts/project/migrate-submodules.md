---
description: Batch migrate or add framework submodules to .kimi
...
```bash
cd .kimi/.kimi
bash scripts/local-submodule-add.sh https://github.com/$GITHUB_ORG/claude-nestjs.git nestjs
```

**For `--django`:**
```bash
cd .kimi/.kimi
bash scripts/local-submodule-add.sh https://github.com/$GITHUB_ORG/claude-django.git django
```

**For `--react`:**
```bash
cd .kimi/.kimi
bash scripts/local-submodule-add.sh https://github.com/$GITHUB_ORG/claude-react.git react
```

**For `--react-native`:**
```bash
cd .kimi/.kimi
bash scripts/local-submodule-add.sh https://github.com/$GITHUB_ORG/claude-react-native.git react-native
```

**For `--marketing`:**
```bash
cd .kimi/.kimi
bash scripts/local-submodule-add.sh https://github.com/$GITHUB_ORG/claude-marketing.git marketing
```

**For `--operations`:**
```bash
cd .kimi/.kimi
bash scripts/local-submodule-add.sh https://github.com/$GITHUB_ORG/claude-operations.git operations
```
...
|-----------|------------|
| base | https://github.com/$GITHUB_ORG/claude-base |
| nestjs | https://github.com/$GITHUB_ORG/claude-nestjs |
| django | https://github.com/$GITHUB_ORG/claude-django |
| react | https://github.com/$GITHUB_ORG/claude-react |
| react-native | https://github.com/$GITHUB_ORG/claude-react-native |
| marketing | https://github.com/$GITHUB_ORG/claude-marketing |
| operations | https://github.com/$GITHUB_ORG/claude-operations |
