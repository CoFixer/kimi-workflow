...
Check that the .kimi submodule is initialized:
...
If MISSING, suggest running `/init-workspace` first, then stop.
...
- Initialized compounding memory system via /init-harness
...
- **.project missing**: Report "Run /init-workspace first"
