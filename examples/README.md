...
Example outputs and references for the `.kimi` workflow system.
...
When you produce good output using `.kimi` workflows, consider adding sanitized examples here for future reference.
