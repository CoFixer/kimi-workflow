...
2. **Read `.kimi/frontend/guides/README.md`** — understand available guides and project structure.
3. **Read all guides relevant to your task from `.kimi/frontend/guides/`:**
...
- Follow patterns from `.kimi/frontend/guides/` exactly. Do not deviate.
...
## 5. Guide Compliance
- List which `.kimi/frontend/guides/` files were read
...
6. **Self-verify** before finishing:
   ...
   - [ ] All relevant `.kimi/frontend/guides/` were read and followed
