...
2. **Read `.kimi/backend/guides/README.md`** — understand available guides and project structure.
3. **Read all guides relevant to your task from `.kimi/backend/guides/`:**
...
- Follow patterns from `.kimi/backend/guides/` exactly. Do not deviate.
...
- List which `.kimi/backend/guides/` files were read
...
5. **Self-verify** before finishing:
   ...
   - [ ] All relevant `.kimi/backend/guides/` were read and followed
