...
|------|----------|----------|
| Skill | Multi-step workflows, external integrations | `.kimi/skills/` |
| Command | Quick utilities, format conversion | `.kimi/commands/` |
| Agent | Domain expertise, autonomous decisions | `.kimi/agents/` |
...
2. Check existing: `Glob(.kimi/skills/*/SKILL.md)`, `Glob(.kimi/agents/**/*.md)`
